...
// TODO: add better support for fetching oembeds
...
if (isNode) {
  ...
  nunjucks.configure('/lib/templates') // todo: make this agnostic to script locations?
}

function convert (markup, templateDir, opts) {
  ...
  sections.globals = Object.assign(opts, sections[0].data)
